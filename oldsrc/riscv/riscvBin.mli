...
val decode : bool -> string -> int -> RiscvISA.minst * int
...
val decode_interval : bool -> string -> int -> int -> RiscvISA.minst list
...
val encode_all : bool -> RiscvISA.minst list -> string
